...
},{"axios":"node_modules/axios/index.js"}],"src/tank-game/realtime-server/client.ts":[function(require,module,exports) {
"use strict";
...
var NakamaClient = /*#__PURE__*/function () {
  ...
  _createClass(NakamaClient, [{
    ...
    value: function connect() {
      ...
      if (!userId) userId = game_framework_1.MathLib.getRandomInt(8).toString();
      var payload = {
        userId: userId
      };
...
},{"./http":"src/tank-game/realtime-server/http.ts","../game-framework":"src/tank-game/game-framework.ts"}],"src/tank-game/game.ts":[function(require,module,exports) {
"use strict";
